#!/bin/bash
# This script will update the database section in DeveloperDashboard.tsx

FILE="/home/z/my-project/src/components/DeveloperDashboard.tsx"

# Backup
cp "$FILE" "$FILE.backup_db"

# The new database section
cat > /tmp/db_section.txt << 'DBEOF'
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid gap-4 md:grid-cols-3">
                    <div className="space-y-3 p-4 rounded bg-slate-700/50 border border-slate-600">
                      ...
                      <Badge variant="outline" className="text-xs mt-1">File-based</Badge>
                    </div>
                    <div className="space-y-3 p-4 rounded bg-slate-700/50 border border-slate-600">
                      <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="space-y-3 p-4 rounded bg-slate-700/50 border border-slate-600">
                      ...
                      <Badge variant="outline" className="text-xs mt-1">1 Connection</Badge>
                    </div>
                  </div>
